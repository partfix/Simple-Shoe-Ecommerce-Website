...
<body>
  ...
  <div class="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden m-4 p-4">
    <?php require_once("../static/admin/order-page.active.php") ?>
  </div>
